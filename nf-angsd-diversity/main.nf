...
params.species     = "Sor"
params.maxdepth    = 1000  // maximum depth to include in analysis. 10x the expected depth across all individuals.
params.minind      = 20    // minimum number of individuals to include in analysis. Eg., 70 percent of the individuals.
